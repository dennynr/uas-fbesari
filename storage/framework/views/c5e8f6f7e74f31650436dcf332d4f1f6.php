            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="card bg-primary text-light p-3 mb-4">
                        ...
                        <span><?php echo e($profitPercentage); ?>%</span>
                        <span>Rp <?php echo e($totalProfit); ?></span>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card bg-danger text-light p-3 mb-4">
                        <h5 class="mb-3">Pengeluaran</h5>
                        <span><?php echo e($expensePercentage); ?>%</span>
                        <span>Rp <?php echo e($totalExpense); ?></span>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card bg-success text-light p-3 mb-4">
                        <h5 class="mb-3 ">Keuntungan Kotor</h5>
                        <h2>Rp <?php echo e($totalProfit); ?></h2>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card bg-success text-light p-3 mb-4">
                        ...
                        <h2>Rp <?php echo e($grossProfit); ?></h2>
                    </div>
                </div>
            </div>
        ...
        var data = {
            ...
            datasets: [{
                ...
                data: [
                    ...
                    <?php echo e($grossProfit); ?>,
                    <?php echo e($totalModal); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project UAS\uas\resources\views/profit.blade.php ENDPATH**/ ?>